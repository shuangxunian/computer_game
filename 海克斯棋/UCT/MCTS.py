...
import constants # 导入棋盘大小的信息
from numpy import random
import math

GRID_SIZE=constants.GRID_SIZE

# 游戏的变量，用于判断是否到达最后的胜利局面
dx = [0, 1, 0, -1, -1, 1]
dy = [-1, -1, 1, 1, 0, 0]
...
class Node():
    ...
    def __init__(self, move_r, move_c, mode, parent=None):
        ...
        self.move=[move_r,move_c] # 当前的坐标
        self.board[move_r][move_c] = mode # 当前游戏的玩家
        self.children = []
...
class MCTS:
    ...
    def move(self): # 选择最优的下一步棋的走法
        for iter in range(200): # 选择多少次用来扩展下一个节点
