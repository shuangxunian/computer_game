...
#include<stdlib.h>
#include<time.h>
#define NumberOfMatches 70//�Ծֻغ�
int AllCards[9][2]; //������ ���ܲ���ʵ
int HandCards[2][2];//����
int FieldCards[5][2];	//����
int KeepCards[7][2];//��ٵ���Ҳ��
int BlindNote=0;   //Сä0��ä1
int Stage;   //�ڼ��׶�  ��preflop,turn,river
int Increase;
int SUMbj;
int SUMbh;
int bujie=0;
...
void main()
{
    ...
    //����Ҫ���ӵķ���˵�ַ
    addrServer.sin_addr.S_un.S_addr=inet_addr("192.168.43.240");//Ŀ��IP(127.0.0.1�ǻ��͵�ַ)
    addrServer.sin_family=AF_INET;
    addrServer.sin_port=htons(10001);//���Ӷ˿ں�
    //���ӵ������
	...
	{	
		...
		if((recvBuf[0]=='n')&&(recvBuf[1]=='a'))//��������
		{			
			strcpy(sendBuf,"watermalen");								
		}
		else if((recvBuf[0]=='p')&&(recvBuf[1]=='r'))//preflop�׶�
		{
			SUMbh=0;
			SUMbj=20000;
			printf("ʣ�������%d\n",SUMbj);
		...
		else if((recvBuf[0]=='f')&&(recvBuf[1]=='l'))//flop�׶�
		{
			SUMbj=SUMbj-SUMbh;
			printf("ʣ�������%d\n",SUMbj);
			SUMbh=0;
		...
		else if((recvBuf[0]=='t')&&(recvBuf[1]=='u'))//turn�׶�
		{
			SUMbj=SUMbj-SUMbh;
			printf("ʣ�������%d\n",SUMbj);
			SUMbh=0;
		...
		else if((recvBuf[0]=='r')&&(recvBuf[1]=='i'))//river�׶�
		{
			SUMbj=SUMbj-SUMbh;
			printf("ʣ�������%d\n",SUMbj);
			SUMbh=0;
